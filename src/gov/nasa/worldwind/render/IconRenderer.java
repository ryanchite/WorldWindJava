 ...
 * <p/>
 * During the draw pass, IconRenderer records feedback information for each WWIcon which has the property key
 * {@link gov.nasa.worldwind.avlist.AVKey#FEEDBACK_ENABLED} set to <code>true</code>. IconRenderer does not record any
 * feedback information during the pick pass. When feedback is enabled, IconRenderer puts properties which describe how
 * each WWIcon has been processed in key-value pairs attached to the WWIcon. Any of these properties may be null,
 * indicating that processing of the WWIcon was terminated before this information became available. The feedback
 * properties for WWIcon are as follows:
 * <table>
 * <tr>
 * <th>Key</th>
 * <th>Description</th>
...
public class IconRenderer {
     ...
     *            <code>true</code> if horizon clipping should be performed, otherwise <code>false</code>.
     *
     ...
     *            <code>true</code> if view clipping should be performed, otherwise <code>false</code>.
     *
     * @see #setHorizonClippingEnabled(boolean)
     */
     ...
     *            <code>true</code> if picking clipping should be performed, otherwise <code>false</code>.
     */
     ...
     *            <code>true</code> to treat icon elevations as absolute, <code>false</code> to treat them as offsets
     *            from the terrain.
     */
    ...
    protected void beginDrawIcons(DrawContext dc) {
        ...
        int attributeMask = GL2.GL_DEPTH_BUFFER_BIT // for depth test, depth mask and depth func
